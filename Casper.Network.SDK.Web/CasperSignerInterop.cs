...
{
    using SignerStateUpdateEventHandler = WalletStateUpdateEventHandler;
    using SignerStateUpdateEventHandlerAsync = WalletStateUpdateEventHandlerAsync;
        
    
    /// <summary>
    /// Service class to interact with Signer extension in the browser.
    /// </summary>
    public class CasperSignerInterop : IWallet, IAsyncDisposable
    {
        ...
        public async Task<WalletState> GetState() =>
            await _callSignerInterop<WalletState>("getCasperSignerState");
